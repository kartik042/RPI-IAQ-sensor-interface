An interface board that connects an Indoor Air quality sensor to GPIO pins of a Raspberry Pi that is used to record the data output from the sensor for data analysis. 
